  ...
  return (
    <>
      <div className="w-full py-10 whitespace-nowrap my-16">
        <div className="bg-[#FCFAFF] w-full px-16 py-4">
          ...
          <div className="flex gap-3 overflow-x-auto no-scrollbar">
            {recentSearches.map((search, index) => (
              ...
              >
                <div className=" flex items-center justify-center bg-[#F9F5FF] w-16 h-16 rounded-full">
                  <div className="bg-[#F4EBFF] w-[75%] h-[75%] rounded-full flex items-center justify-center">
                    <i className="fi fi-rr-search text-[#7F56D9]"></i>
                  </div>
                </div>
                <p className="text-lg font-normal">{search.landmark}</p>
