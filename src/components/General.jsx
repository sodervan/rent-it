		...
		<div className="container mx-auto">
			...
			<div className="flex items-center justify-center md:grid grid-cols-2 w-full bg-[#F4EBFF] px-6 sm:px-20 md:items-center md:justify-between mb-9 gap-8">
				<div className="flex flex-col gap-6 items-start my-10">
					...
					<p className="text-sm text-gray-700">
						Find your perfect home with ease. Our platform offers
						you a seamless experience to search, compare, and secure
						your next apartment, all in one place. Explore verified
						listings and connect directly with landlords or agents.
					</p>
			...
			<div className="flex items-center justify-center md:grid grid-cols-2 w-full bg-[#F4EBFF] px-6 sm:px-20 md:items-center md:justify-between mb-9 gap-8">
				<div className="flex flex-col gap-6 items-start my-10">
					...
					<p className="text-sm text-gray-700">
						Spread the good news! Earn more by helping your friends,
						clients find an apartment they truly love. Refer and
						earn for each successful booking made on the platform.
					</p>
					<div className="bg-[#7F56D9] px-5 py-3 rounded-lg">
						<button className="text-white font-medium">
							Expand Your Reach
