        ...
        >
            ...
            <div className="h-32 flex  rounded-full">
              {userInfo?.payload.profilePicFileName ? (
                <img
                  ...
                  src={userInfo?.payload.profilePicLink ?? undefined}
                  alt=""
                />
              ) : (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 justify-center mt-4">
            <div className="py-2 flex flex-col  gap-2">
              <label className=" opacity-70 font-bold">FirstName</label>
              <TextInput
                name="firstname"
            ...
            <div className="py-2 flex flex-col  gap-2">
              <label className=" opacity-70 font-bold">LastName</label>
              <TextInput
                rightSection={<IconUser size={16} />}
                name="lastname"
            ...
            <div className="py-2 flex flex-col  gap-2">
              <label className=" opacity-70 font-bold">Phone Number</label>
              <TextInput
                rightSection={<IconUser size={16} />}
                name="phoneNumber"
                type="number"
                defaultValue={userInfo?.payload.phoneNumber ?? "000"}
              />
            </div>
            <div className="py-2 flex flex-col  gap-2">
              <label className=" opacity-70 font-bold">Date Of Birth</label>
              <TextInput
                rightSection={<IconUser size={16} />}
                name="date"
                type="number"
            ...
            <div className="py-2 flex flex-col  gap-2">
              <label className=" opacity-70 font-bold">SchoolId</label>
              <TextInput
                rightSection={<IconUser size={16} />}
                name="schoolId"
                type="number"
